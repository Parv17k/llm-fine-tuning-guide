...
| 03 | [Your First Fine-Tune](./04-first-fine-tune.md) | Complete end-to-end example with Qwen3-8B | 60 min |
...
4. **Your first fine-tuned model** — Qwen3-8B adapted for formal writing
