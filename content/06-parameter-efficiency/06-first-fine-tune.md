...
> **Lesson 03** — A minimal end-to-end QLoRA example using Qwen3-8B.
...
> **Prerequisites**: Read [Parameter Efficiency Guide](./06-parameter-efficiency-guide.md) first for the theory behind LoRA, QLoRA, and adapter methods. This lesson applies those concepts in a complete working example.
...
3. **Add alignment** — DPO, ORPO, KTO, GRPO, or GMPO for preference optimization ([Module 07](../07-alignment/))
4. **Add evaluation metrics** — BLEU, ROUGE, human evaluation ([Module 08](../08-evaluation/))
5. **Deploy the model** — vLLM 0.11+, TGI, or llama.cpp (GGUF) ([Module 09](../09-model-deployment/))
6. **Read [Data Engineering](../04-data-engineering/)** — Building and curating training datasets
